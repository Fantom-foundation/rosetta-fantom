...
GO_PACKAGES=./services/... ./cmd/... ./configuration/... ./fantom/...
...
run-mainnet-online:
	docker run -d --ulimit "nofile=${NOFILE}:${NOFILE}" -v "${PWD}/opera-data-mainnet:/data" -e "MODE=ONLINE" -e "NETWORK=MAINNET" -e "PORT=8080" -p 8080:8080 -p 5050:5050 -p 18545:18545 rosetta-fantom:latest

run-mainnet-online-var:
	docker run -d --ulimit "nofile=${NOFILE}:${NOFILE}" -v "/var/opera/mainnet:/data" -e "MODE=ONLINE" -e "NETWORK=MAINNET" -e "PORT=8080" -p 8080:8080 -p 5050:5050 -p 18545:18545 rosetta-fantom:latest

run-mainnet-offline:
	docker run -d --rm -e "MODE=OFFLINE" -e "NETWORK=MAINNET" -e "PORT=8081" -p 8081:8081 rosetta-fantom:latest

run-testnet-online:
	docker run -d --ulimit "nofile=${NOFILE}:${NOFILE}" -v "${PWD}/opera-data-testnet:/data" -e "MODE=ONLINE" -e "NETWORK=TESTNET" -e "PORT=8080" -p 8080:8080 -p 5050:5050 -p 18545:18545 rosetta-fantom:latest

run-testnet-online-var:
	docker run -d --ulimit "nofile=${NOFILE}:${NOFILE}" -v "/var/opera/testnet:/data" -e "MODE=ONLINE" -e "NETWORK=TESTNET" -e "PORT=8080" -p 8080:8080 -p 5050:5050 -p 18545:18545 rosetta-fantom:latest

run-testnet-offline:
	docker run --rm -e "MODE=OFFLINE" -e "NETWORK=TESTNET" -e "PORT=8081" -p 8081:8081 rosetta-fantom:latest

run-mainnet-remote:
	docker run --rm --ulimit "nofile=${NOFILE}:${NOFILE}" -e "MODE=ONLINE" -e "NETWORK=MAINNET" -e "PORT=8080" -e "OPERA=$(opera)" -p 8080:8080 rosetta-fantom:latest

run-testnet-remote:
	docker run --rm --ulimit "nofile=${NOFILE}:${NOFILE}" -e "MODE=ONLINE" -e "NETWORK=TESTNET" -e "PORT=8080" -e "OPERA=$(opera)" -p 8080:8080 rosetta-fantom:latest
