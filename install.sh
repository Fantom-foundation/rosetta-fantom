...
usage() {
  this=$1
  cat <<EOF
$this: download pre-compiled Docker images for Fantom-foundation/rosetta-fantom
...
execute() {
  ...
  docker tag "rosetta-fantom:${TAG}" "rosetta-fantom:latest"
  log_info "loaded rosetta-fantom:${TAG} and tagged as rosetta-fantom:latest"
  rm -rf "${tmpdir}"
